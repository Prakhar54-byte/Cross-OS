...
ApplicationWindow {
    ...
    Shortcut {
        sequence: "Shift+Tab"
        onActivated: currentTab = (currentTab - 1 + 5) % 5
    }
    Shortcut {
        sequence: "Backtab"
        onActivated: currentTab = (currentTab - 1 + 5) % 5
    ...
    ColumnLayout {
        ...
        StackLayout {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    ListView {
                        ...
                        Text {
                            text: "Trash is empty. Clean space, clean mind!"
                            color: "#555555"
                            font.family: "monospace"
                            font.pixelSize: 13
                            anchors.centerIn: parent
                ...
                Text {
                    text: "* Items in Trash are kept for 1 week before being deleted permanently."
                    color: "#550000"
                    font.family: "monospace"
                    font.pixelSize: 11
                    wrapMode: Text.Wrap
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Text {
                        text: " ┌── DETECTED STORAGE DRIVES (Click to select) ──┐ "
                        color: "#00FF00"
                        font.family: "monospace"
                        font.bold: true
                        anchors.top: parent.top
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            width: drivesListView.width
                            height: 65
                            color: "black"
                            border.color: modelData.isCompatible ? "#00FF00" : "#333333"
                            border.width: 1

                            MouseArea {
                                anchors.fill: parent
                                enabled: modelData.isWritable && modelData.isCompatible
                                hoverEnabled: true
                                onClicked: {
                                    let cleanPath = modelData.rootPath;
                                    if (!cleanPath.endsWith("/") && !cleanPath.endsWith("\\")) {
                                        cleanPath += "/";
                                    }
                                    pathInputField.text = cleanPath + ".os_dropzone/shared_notes.txt";
                                }
                            }
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    Text {
                                        text: "├─ " + modelData.name + " [" + modelData.fileSystemType.toUpperCase() + "]"
                                        color: "#00FF00"
                                        font.family: "monospace"
                                        font.bold: true
                                        font.pixelSize: 11
                                    ...
                                    Item { Layout.fillWidth: true }
                                    Text {
                                        text: modelData.isCompatible ? "[ COMPATIBLE ]" : "[ NOT CROSS-OS ]"
                                        color: modelData.isCompatible ? "#00FF00" : "#555555"
                                        font.family: "monospace"
                                        font.bold: true
                                        font.pixelSize: 10
                                    }
                                ...
                                Text {
                                    text: "│  Free: " + (modelData.bytesAvailable / (1024 * 1024 * 1024)).toFixed(1) + " GB / " + (modelData.bytesTotal / (1024 * 1024 * 1024)).toFixed(1) + " GB"
                                    color: "#008800"
                                    font.family: "monospace"
                                    font.pixelSize: 11
                                }
                ...
                Button {
                    id: scanDrivesAction
                    text: "[ SCAN & DETECT STORAGE DRIVES ]"
                    Layout.fillWidth: true
                    Layout.preferredHeight: 35
                    onClicked: Backend.refreshMountedDrives()
                    contentItem: Text {
                        text: scanDrivesAction.text
                        color: scanDrivesAction.hovered ? "black" : "#00FF00"
                        font.family: "monospace"
                        font.bold: true
                        horizontalAlignment: Text.AlignHCenter
                        verticalAlignment: Text.AlignVCenter
                    ...
                    background: Rectangle {
                        color: scanDrivesAction.hovered ? "#00FF00" : "black"
                        border.color: "#00FF00"
                        border.width: 1
                    }
                }
                    ...
                    ScrollView {
                        ...
                        Text {
                            text: "To share notes/links sequentially on dual-boot machines:\n\n" +
                                  ...
                                  "3. Open Settings (F4) and sync paths to point to:\n" +
                                  ...
                                  "3. Enable LAN SYNC.\n" +
                                  "4. Enable CLIPBOARD SYNC in Settings (F4).\n" +
        ...
        Rectangle {
            ...
            Text {
                text: " [TAB] Cycle │ F1 Feed │ F2 Peers │ F3 Trash │ F4 Settings │ F5 Help "
                color: "#00FF00"
                font.family: "monospace"
                font.pixelSize: 12
                font.bold: true
